    ...
    var sharePhotosNetworkMessage: String {
        ...
        if let urlError = self as? URLError {
            ...
            case .notConnectedToInternet:
                return "连接失败：iOS 可能没有允许本地网络访问，或手机和 Mac 不在同一个 Wi-Fi。请到 设置 > SharePhotos > 本地网络 打开权限后重试。"
            case .cannotConnectToHost, .timedOut, .networkConnectionLost:
                return "连接失败：没有连上 SharePhotos 服务。请确认服务已启动、手机和 Mac 在同一个 Wi-Fi，并检查服务地址是否正确。"
